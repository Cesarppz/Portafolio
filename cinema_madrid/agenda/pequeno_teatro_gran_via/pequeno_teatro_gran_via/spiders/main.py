...
class Webscrape(scrapy.Spider):
    ...
    def new_parse(self, response, **kwargs):
        ...
        category = remove_blank_spaces(' '.join(category).split(',')[1]).strip()
        print(category)
        ...
        #category
        categrory = remove_blank_spaces(category)
        ...
        yield { 
                ...
                'Place_name/address':'Pequeño Teatro Gran Via',
                'Categoria' : category,
                ...
                'Province': 'Madrid',
                'Country':'España',
                'latitud':'4.042.241.629.999.990',
                'longitud':'-3.708.937.199.999.990',
                'Link':link
