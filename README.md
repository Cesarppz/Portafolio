    ...
    <ul>
        <li>
            <a href = https://github.com/Cesarppz/Portafolio/blob/master/Titanic.ipynb >
                Titanic Dataset <img width = '26px' align = 'rigth' alt= 'Titanic' src = https://raw.githubusercontent.com/Cesarppz/Portafolio/master/data/titanic_icon.png style ="max-width:100%;bostylerder-bottom-style: solid;border-bottom-width: 0px;margin-bottom: -5px;" ></img>
            <a>
        </li>
    </ul><br />
    <li>Scraping</li>
