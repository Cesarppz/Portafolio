    ...
    <ul>
        <li>
            <a href = https://github.com/Cesarppz/Portafolio/blob/master/Titanic.ipynb >
                Titanic Dataset <img width = '26px' align = 'rigth' alt= 'Titanic' src = https://raw.githubusercontent.com/Cesarppz/Portafolio/master/data/titanic_icon.png top = '10px' ></img>
            <a>
        </li>
    </ul><br />
    <li>Scraping</li>
